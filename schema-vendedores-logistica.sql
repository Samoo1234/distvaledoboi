-- EXTENSÃO DO SISTEMA VALE DO BOI
...
-- Tabela de perfis específicos de vendedores
...
-- Tabela de territórios de vendas
...
-- Mensagem de sucesso
SELECT 'TABELAS DE VENDEDORES E LOGÍSTICA CRIADAS COM SUCESSO!' as resultado; 