-- Schema SQL CORRIGIDO para o banco de dados Supabase do Sistema Vale do Boi
-- Este arquivo deve ser executado no SQL Editor do Supabase
-- VERSÃO CORRIGIDA - Resolve problemas com políticas RLS
...
-- Tabela de perfis de usuários (substitui a modificação direta da tabela auth.users)
...
('Alcatra', 'Corte bovino nobre, ideal para assados', 28.90, 50.0, 'Bovino', 'BOV-ALC-001'),
('Picanha', 'Corte premium para churrasco', 45.90, 30.0, 'Bovino', 'BOV-PIC-001'),
('Fraldinha', 'Corte saboroso para grelhar', 32.90, 40.0, 'Bovino', 'BOV-FRA-001'),
('Costela', 'Ideal para cozidos e assados', 18.90, 60.0, 'Bovino', 'BOV-COS-001'),
('Linguiça Calabresa', 'Linguiça temperada tradicional', 15.90, 100.0, 'Embutidos', 'EMB-LIN-001'),
('Bacon Fatiado', 'Bacon em fatias para preparo', 24.90, 25.0, 'Suínos', 'SUI-BAC-001')
